<%@page import="in.co.pro4.controller.FacultyCtl"%>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="dob"
						placeholder="Enter Date Of Birth" style="width: 231px;"
				...
				<tr>
					...
					<td><input type="text" name="loginid"
						placeholder=" Enter Login Id" style="width: 231px;"
				...
				<tr>
					...
					<td><input type="text" name="mobileno" style="width: 231px;"
