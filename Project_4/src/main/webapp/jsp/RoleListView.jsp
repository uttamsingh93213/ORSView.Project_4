<%@page import="in.co.pro4.model.*"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.co.pro4.utility.*"%>

<%@page import="in.co.pro4.controller.*"%>
...
<body>
	<jsp:useBean id="bean" class="in.co.pro4.bean.RoleBean" scope="request"></jsp:useBean>
	...
	<center>
		...
		<form action="<%=ORSView.ROLE_LIST_CTL%>" method="post">
			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label>Role :</label> <%=HTMLUtility.getList("roleid", String.valueOf(bean.getId()), rlist)%>
