...
<body>
	<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label> Student Name :</font></label> <input
						type="text" name="name" placeholder="Enter Student Name" size="26"
						value="<%=ServletUtility.getParameter("name", request)%>">
						&emsp; <label>RollNo :</label> <%=HTMLUtility.getList("rollNo", String.valueOf(bean.getRollNo()), l)%>
						&nbsp; <input type="submit" name="operation" size="26"
			...
			<br>
			<table border="2" width="100%" align="center" cellpadding=6px
				cellspacing=".3">
				<tr bgcolor="#0FFAAD">
 ...
 %>
			...
			<input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
				type="hidden" name="pageSize" value="<%=pageSize%>"> </br> </br> </br> </br> </br> </br>
		</center>
	</form>
