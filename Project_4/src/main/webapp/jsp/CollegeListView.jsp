...
<%@page import="in.co.pro4.bean.CollegeBean"%>
<%@page import="in.co.pro4.utility.DataUtility"%>
<%@page import="in.co.pro4.utility.ServletUtility"%>
<%@page import="in.co.pro4.controller.CollegeListCtl"%>
...
<body>
	...
	<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
		...
		<center>
			...
			<table width="80%" align="center">
				<tr>
					<td align="center"><label> College Name :</label> <%=HTMLUtility.getList("collegeid", String.valueOf(bean.getId()), clist)%>

						&nbsp; <label>City :</label> <input type="text" name="city"
						placeholder="Enter City Name" style="width: 231px;"
 ...
 %>
					...
					<td><input type="submit" name="operation"
						...
						<%if (userBean.getRoleId() == RoleBean.STUDENT) {%> <%="disabled"%>
						<%}%>></td>
					<td><input type="submit" name="operation"
