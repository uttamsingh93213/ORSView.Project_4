...
<%@page import="in.co.pro4.controller.MarksheetCtl"%>
			...
			<table align="center">
				<tr>
					...
					<td><input type="text" name="rollNo"
						placeholder="Enter RollNo" style="width: 231px;"
				...
				<tr>
					...
					<td><input type="number" name="physics" maxlength="3"
						placeholder="Enter Physics Marks" style="width: 231px;"
				...
				<tr>
					...
					<td><input type="number" name="chemistry" maxlength="3"
						placeholder="Enter Chemistry Marks" style="width: 231px;"
				...
				<tr>
					...
					<td><input type="number" name="maths" maxlength="3"
						placeholder="Enter Maths Marks" style="width: 231px;"
